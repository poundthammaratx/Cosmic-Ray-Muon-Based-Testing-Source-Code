...
# - Plots Charge Distributions in pC and Photoelectrons (PE) with a logarithmic Y-axis for better visibility of higher charge events.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", "-o", help="Output directory for plots (default: ./figs)", type=str, default='./figs') # <<< Added argument for output directory
    ...
    plot_all_charge_dists(filenames, [-0.1, 1.5], unit_label='Charge (pC)', save_suffix='muon_pC', output_dir=args.output_dir) # <<< Pass args.output_dir
    ...
    plot_all_charge_dists_pe(filenames, assumed_gain=5e6, save_suffix='muon_pe', output_dir=args.output_dir) # <<< Pass args.output_dir
